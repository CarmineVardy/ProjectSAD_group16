...
/**
 * Implements the {@link ToolStrategy} for drawing lines.
 * This strategy handles mouse events to allow users to create new line shapes
...
public class LineToolStrategy implements ToolStrategy {
    ...
    /**
     * Constructs a new {@code LineToolStrategy}.
     *
    ...
    /**
     * Activates the line tool, setting its initial border color.
     *
     ...
     * Starts the drawing of a new line from the clicked point and
     ...
     * Updates the end point of the preview line as the mouse is dragged.
     *
     ...
     * Finalizes the line creation if its length is above a minimum threshold,
     ...
     * Updates the internal border color used for new lines.
     *
    ...
    public void handleKeyPressed(KeyEvent event) {
        // No specific action on key pressed for line tool
    }
    ...
    public void handleKeyTyped(KeyEvent event) {
        // No specific action on key typed for line tool
    }
     ...
     * This is called to clean up the canvas after a line is finalized or cancelled.
     */
    @Override
    public void reset() {
