...
/**
 * Implements the {@link ToolStrategy} for drawing rectangles.
 * This strategy handles mouse events to allow users to create new rectangle shapes
...
public class RectangleToolStrategy implements ToolStrategy {
    ...
    /**
     * Constructs a new {@code RectangleToolStrategy}.
     *
    ...
    /**
     * Activates the rectangle tool, setting its initial border and fill colors.
     *
     ...
     * Starts the drawing of a new rectangle from the clicked point and
     ...
     * Updates the dimensions of the preview rectangle as the mouse is dragged.
     *
     ...
     * Finalizes the rectangle creation if its dimensions are above a minimum threshold,
    ...
    public void handleLineBorderColorChange(Color color) {
        // Not applicable for rectangle tool
    }

    /**
     * Handles a change in the rectangle border color property.
     * Updates the internal border color used for new rectangles.
     *
     ...
     * Updates the internal fill color used for new rectangles.
     *
    ...
    public void handleKeyPressed(KeyEvent event) {
        // No specific action on key pressed for rectangle tool
    }
    ...
    public void handleKeyTyped(KeyEvent event) {
        // No specific action on key typed for rectangle tool
    }
     ...
     * This is called to clean up the canvas after a rectangle is finalized or cancelled.
     */
    @Override
    public void reset() {
