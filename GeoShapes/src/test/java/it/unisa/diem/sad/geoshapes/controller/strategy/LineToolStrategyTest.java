...
public class LineToolStrategyTest {
    ...
    private LineToolStrategy strategy;
    ...
    public void setUp() {
        ...
        drawingArea.resize(100, 100); // <-- fondamentale!
        borderColorPicker = new ColorPicker(Color.BLACK);
        fillColorPicker = new ColorPicker(Color.TRANSPARENT);
        strategy = new LineToolStrategy(drawingArea, borderColorPicker, fillColorPicker);
    }

    @Test
    public void testHandlePressedAndDraggedAndReleased_CreatesValidLine() {
        ...
        assertNotNull(shape, "La linea dovrebbe essere creata se la lunghezza è sufficiente");
    ...
    @Test
    public void testHandleReleased_TooShortLine_NoShapeCreated() {
        ...
        MouseEvent release = new MouseEvent(MouseEvent.MOUSE_RELEASED, 11, 10, 11, 10, MouseButton.PRIMARY, 1,
                false, false, false, false, true, false, false, true, false, false, null);
        strategy.handleReleased(release);

        MyShape shape = strategy.getFinalShape();
        assertNull(shape, "La linea non dovrebbe essere creata se troppo corta");
    }
