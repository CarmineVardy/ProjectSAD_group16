...
public class RectangleToolStrategyTest {
    ...
    private RectangleToolStrategy strategy;
    ...
    public void setUp() {
        ...
        fillColorPicker = new ColorPicker(Color.RED);
        strategy = new RectangleToolStrategy(drawingArea, borderColorPicker, fillColorPicker);
    }

    @Test
    public void testHandlePressedAndDraggedAndReleased_CreatesValidRectangle() {
        ...
        assertNotNull(shape, "Il rettangolo dovrebbe essere creato se le dimensioni sono sufficienti");
    ...
    @Test
    public void testHandleReleased_TooSmallRectangle_NoShapeCreated() {
        ...
        MyShape shape = strategy.getFinalShape();
        assertNull(shape, "Il rettangolo non dovrebbe essere creato se troppo piccolo");
    }
